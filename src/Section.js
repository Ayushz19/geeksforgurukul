          ...
          <div className="main-boxes mt-[-15px] ">
            <div className="box-1 w-auto inline-block  relative overflow-hidden md:mx-[20px] mx-[10px] flex flex-col justify-between items-center dark:bg-[#191C1E] bg-[#D1FFD0] w-[220px] md:w-[280px] h-[350px] md:h-[409px] rounded-[20px]">
              ...
              <div className="after-hover">
                <p className="font-[500] md:text-[24px] text-[16px] dark:text-[White] text-[#101010] text-left p-4 ">
                  {" "}
                  Akash Kumar
                </p>
                <p className="font-[500] md:text-[16px] text-[16px] dark:text-[White] text-[#101010] mt-4 text-left	p-4 ">
                  {" "}
                  I chose to join Geeks of Gurukul as an instructor because of
                  its exceptional reputation in the tech industry. Geeks of
                  Gururkul’s resources and network allows you to stay connected
                  with industry leaders, thus expanding your career
                  opportunities.
                </p>
              </div>
